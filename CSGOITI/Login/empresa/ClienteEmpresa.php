<?php
    include("../sesion.php");
session_start();
if(isset($_SESSION['ID']) && $_SESSION['ROL'] === "rol_empresa"){
    $IDUSER = $_SESSION['ID'];
}    

if(!empty($IDUSER)){

$consulta1 = "SELECT cliente_empresa.rut, cliente_empresa.nombre, cliente.correo, cliente.direccion, cliente.puerta, cliente.postal, cliente.foto_perfil
FROM cliente, cliente_empresa
WHERE cliente.nº_cliente = '$IDUSER' AND cliente.nº_cliente = cliente_empresa.nº_cliente;";
$res1 = mysqli_query($conexion, $consulta1);
$row1 = mysqli_fetch_array($res1);
$correo = $row1['correo'];
sleep(0.05);
$consulta2 = "SELECT usuario.password FROM usuario WHERE usuario.correo = '$correo';";
...
<div class="all-container">
    ...
    <div class="panel" id="panel-big">
        ...
        <div class="selector-admin">
            <button class="boton-sel" id="btn-user"><i class="far fa-paper-plane"></i><p>AJUSTES</p></button>
    ...
    <div class="delContainer">
        ...
        <p class="no sn">NO<i class="fas fa-times-circle"></i></p>
            ...
            <div class="container" id="user">
                <h3><h3><p><?php echo $row1['nombre']; ?></p><img class="foto foto-top" src="<?php echo $row1['foto_perfil']?>"> </h3></h3>
                ...
                <div class="settings-container">
                    ...
                    <div id="img-perfil">
                        ...
                        <div class="rut"><p>RUT</p><input type="number" value="<?php echo $row1['rut'] ?>" disabled></div>
