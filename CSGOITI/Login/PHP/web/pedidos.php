...
= '$ID' AND esta.nº_cliente = '$ID' AND (esta.id_estado_pedido = 2 OR esta.id_estado_pedido = 3) AND esta.fecha_final_estado = '0000-00-00 00:00:00'
ORDER BY esta.nº_pedido ASC;";
